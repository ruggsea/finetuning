#!/bin/zsh
#SBATCH --job-name=llama70b_instruct_finetune
#SBATCH --output=logs/llama70b_instruct_finetune_%j.out
#SBATCH --error=logs/llama70b_instruct_finetune_%j.err
#SBATCH --nodes=1
...
python finetune_llama70b_instruct_cot_wsdm.py 